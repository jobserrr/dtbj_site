                  ...
                  <div class="row gutters">
                    <form action="change-u.php" method="post">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h3 class="mb-3 text-primary">Change Username</h3>
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                          <label for="fullName">Old Username</label>
                          <input type="text" name="ou" class="form-control" placeholder="Old Username">
                        </div>
                      </div>
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                          ...
                          <br>
                          <input type="text" name="nu" class="form-control" placeholder="New Username">
                        </div>
                      </div>
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                          <label for="phone">Confirm New Username</label>
                          <br>
                          <input type="text" name="c_nu" class="form-control" placeholder="Confirm New Username">
                        </div>
                      </div>
